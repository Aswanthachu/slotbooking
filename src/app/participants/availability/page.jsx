...
const AvailabilityPage = () => {
  ...
  return (
    <div className="p-6 bg-white">
      ...
      {availableSlots && Object.entries(availableSlots).length > 0 ? (
        <div className="mt-6 bg-[#f5f0e6] p-4 rounded-3xl md:max-w-2xl lg:max-w-3xl mx-auto sm:px-6 md:px-10 lg:px-20 !my-20">
          ...
          {Object.entries(availableSlots).map(([date, timeSlots]) => (
            ...
            >
              <div className="text-sm font-semibold mb-2 md:mb-0 flex">
                {date} :
              </div>
              <div className="flex flex-wrap gap-2">
                {timeSlots.map((slot, index) => (
                  ...
                  >
                    ...
                    <p className="truncate">{slot.start}-{slot.end}</p>
                  </span>
                ))}
              </div>
            </div>
        ...
        <div className="mt-6 p-4 rounded-3xl md:max-w-2xl lg:max-w-3xl mx-auto sm:px-6 md:px-10 lg:px-20 !my-20">
